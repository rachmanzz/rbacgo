...
func tenantMiddleware(registry *TenantRegistry, opts ...TenantOption) gin.HandlerFunc {
	all := []TenantOption{
		WithTenantResolver(func(c *gin.Context) (string, bool) {
			t := c.GetHeader("X-Tenant-ID")
			return t, t != ""
		}),
		WithTenantUserID(func(c *gin.Context) (string, bool) {
...
func doTenantRequest(mw gin.HandlerFunc, tenant, user string) *httptest.ResponseRecorder {
...
func TestTenantPanics(t *testing.T) {
	...
	if err := func() (err any) {
		defer func() { err = recover() }()
		TenantMiddleware(reg, WithTenantUserID(func(*gin.Context) (string, bool) { return "", true }))
		return nil
	}(); err == nil {
	...
	if err := func() (err any) {
		defer func() { err = recover() }()
		TenantMiddleware(reg, WithTenantResolver(func(*gin.Context) (string, bool) { return "", false }))
		return nil
	}(); err == nil {
